...
class PoliticalController extends Controller
{
    ...
    public function index()
    {
        ...
        // die();
        return view('political.index',$data);
    }
    ...
    public function filterby_category($id)
    {
        ...
        $data['sections'] = Section::where('status','0')->get();
        $data['posts'] = Posts::with('section')->where('type','political')->where('category_id',$id)->orderBy('id', 'DESC')->paginate(12);
        $data['categories'] = Category::where('status','0')->where('type','political')->get();
    ...
    public function create()
    {
        ...
        // echo(json_encode($data['posts']));
        // die();
        return view('political.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['languages'] = Language::where('status','0')->get();
        $data['categories'] = Category::where('status','0')->where('type','political')->get();
        return view('political.edit',$data);
    }
