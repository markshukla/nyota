          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Greeting Post</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('greeting.update',$post->id) }}" id="addform" enctype="multipart/form-data" >
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="category" required="required">
                                @foreach ($sections as $c)
                                    <option value="{{$c->id}}" @if($c->id == $post->section_id) selected @endif>{{ $c->name }}</option>
                                @endforeach
                            </select>
