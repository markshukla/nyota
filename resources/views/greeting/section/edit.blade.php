          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Greeting Section</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action=" {{ route('greetingsection.update',$section->id) }} " id="addform" enctype="multipart/form-data" >
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" value="{{ $section->name }}" required>
