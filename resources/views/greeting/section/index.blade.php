                ...
                <div class="d-flex align-items-center">
                   <h6 class="text-white" >Greeting Section</h6>
                    ...
                    <div class="ms-auto mt-3">
                        <a href="{{ route('greetingsection.create')}}" class="btn btn-success "><i class="fas fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($sections as $section)
                       <tr id="{{ $section->id }}">
                            ...
                            <div class="ms-auto text-end align-middle text-center text-sm">
                                ...
                                <a class="btn btn-icon-only btn-rounded btn-success" href="{{secure_url('/greetingsection/'.$section->id.'/edit')}}"><i class="fas fa-pencil-alt"></i></a>
                            </div>
                            </td>
                       </tr>
                       
                        <form action="{{ url('greetingsection/'.$section->id) }}" method="POST" id="form-{{ $section->id }}">
                            @method('DELETE')
                            @csrf
