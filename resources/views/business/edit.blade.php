          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Business Post</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('business.update',$post->id) }}" id="addform" enctype="multipart/form-data" >
                          ...
                          <div class="form-group">
                            ...
                            <select class="fstdropdown-select form-control" id="sub_category_id" name="subcategory">
                                @foreach ($subcategories as $sc)
                                    <option value="{{$sc->id}}" @if($sc->id == $post->sub_category_id) selected @endif>{{ $sc->name }}</option>
                                @endforeach
                            </select>
