        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('admins.store') }}" id="addform" enctype="multipart/form-data" >
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="section" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Category</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="category" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="posts" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class="font-weight-bolder text-sm">Greeting</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="greeting" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="video" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Slider</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="slider" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="frame" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Subscription</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="subscription" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="offerdialog" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Push Notification</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="pushnotification" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="contacts" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Transaction</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="transaction" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="user" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                        <td class=" font-weight-bolder text-sm">Setting</td>
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="setting" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-switch align-items-center justify-content-center" >
                                               <input name="admin" class="form-check-input status-switch" type="checkbox">
                                            </div>
                                        </td>
