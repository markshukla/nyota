          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Sub Category </p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('subcategory.update',$category->id) }}" id="addform" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Select Category </label>
                                ...
                                @foreach ($businessCategories as $cate)
                                    <option value="{{ $cate->id }}"  @if($category->category_id == $cate->id) selected @endif>{{ $cate->name }}</option>
                                @endforeach
                                </select>
