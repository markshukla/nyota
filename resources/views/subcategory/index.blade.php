                ...
                <div class="d-flex align-items-center">
                   <h6 class="text-white" >{{ ucfirst($type) }} Sub Category</h6>
                    ...
                    <div class="ms-auto mt-3 d-flex">
                        ...
                        <a href="{{ route('subcategory.create')}}" class="btn btn-success "><i class="fas fa-plus"></i> Add Category</a>
                    </div>
                </div>
            </div>
                       ...
                       <tr>
                            ...
                            <td>
                               <div class="d-flex px-2 py-1">
                                  <div>
                                    <img src="{{ asset($category->image) }}" class="avatar avatar-xl me-3" alt="user1">
                                  </div>
                            ...
                            <td class="align-middle text-center">
                                <span class="text-secondary text-xs font-weight-bold">{{ $category->category->name }}</span>
                            </td>
                            ...
                            <div class="ms-auto text-end align-middle text-center text-sm">
                                ...
                                <a class="btn btn-icon-only btn-rounded btn btn-success" href="{{secure_url('/subcategory/'.$category->id.'/edit')}}"><i class="fas fa-pencil-alt"></i></a>
                            </div>
                            </td>
                       </tr>
                       
                        <form action="{{ url('subcategory/'.$category->id) }}" method="POST" id="form-{{ $category->id }}">
                            @method('DELETE')
                            @csrf
