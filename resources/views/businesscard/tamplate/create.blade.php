          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Business Card Tamplate</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('businesscardtamplate.store') }}" id="addform" enctype="multipart/form-data" >
