          ...
          <div class="card mb-4">
            ...
            <div class="card-body mt-n3">
                ...
                <div class="row mb" >
                    ...
                    <div class="col-xl-4 col-l-4 col-sm-4 p-2  bg-transparent">
                       ...
                       <div style="border-radius: 14px;">
                            ...
                            <div class="mt-9" >
                                ...
                                <div class="d-flex mt-2" >
                                  <div>
                                    <a class="btn btn-icon-only btn-rounded btn-success mb-0 me-2 btn-sm d-flex align-items-center justify-content-center" href="{{secure_url('/businesscardtamplate/'.$post->id.'/edit')}}">
                                ...
                                <form action="{{ url('businesscardtamplate/'.$post->id) }}" method="POST" id="form-{{ $post->id }}">
                                    @method('DELETE')
                                    @csrf
                ...
                <div class="d-flex justify-content-center">{{ $tamplates->links() }}</div>
...
<script>
    ...
    function cheakPremium(id){
        ...
        $.ajax({
          type: "POST",
          url: "{{ secure_url('/bsns-tmplt-premium-action') }}",
    ...
    $(".status-switch").change(function(){
        ...
        $.ajax({
          type: "POST",
          url: "{{ secure_url('/bsns-tmplt-card-status') }}",
