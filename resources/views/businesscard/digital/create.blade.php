          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Business Card Digital</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('businesscarddigital.store') }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" placeholder="Business Card 1" required>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Blade Name <b style="color:red">{{ $errors->first('title') }}</b></label>
                            <input class="form-control" name="blade_name" type="text" placeholder="Business Card 1" required>
                          </div>
                        </div>
