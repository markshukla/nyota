                ...
                <div class="d-flex align-items-center">
                   <h6 class="text-white" >Notifications</h6>
                    ...
                    <div class="ms-auto mt-3">
                        <a href="{{ route('pushnotification.create')}}" class="btn btn-success "><i class="fas fa-plus"></i>  New Push</a>
                    </div>
                </div>
            </div>
                       ...
                       <tr>
                            ...
                            <td>
                               <div class="d-flex px-2 py-1">
                                  <div>
                                    <img src="@if($notification->thumbnail) {{url($notification->thumbnail)}} @else {{url('/images/placeholder.jpg')}} @endif" class="avatar avatar-xl me-3" alt="user1">
                                  </div>
                            ...
                            <td class="align-middle">
                                <div class="form-switch align-items-center justify-content-center" >
                                    <input class="form-check-input status-switch" type="checkbox" data-id="{{$notification->id}}" @if($notification->status==0) checked @endif>
                                </div>
                            </td>
                            ...
                            <div class="ms-auto text-end align-middle text-center text-sm">
                                ...
                                <a class="btn btn-icon-only btn-rounded btn btn-success" href="{{secure_url('/pushnotification/'.$notification->id.'/edit')}}"><i class="fas fa-pencil-alt"></i></a>
                            </div>
                            </td>
                       </tr>
                       
                        <form action="{{ url('pushnotification/'.$notification->id) }}" method="POST" id="form-{{ $notification->id }}">
                            @method('DELETE')
                            @csrf
