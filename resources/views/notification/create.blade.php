          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Push Notification</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('pushnotification.store') }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" placeholder="Offer" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Message <b style="color:red">{{ $errors->first('message') }}</b></label>
                            <input class="form-control" name="message" type="text" placeholder="Write message here" required>
                          </div>
                        </div>
                        <div class="col-md-6">
