          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Notification</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('pushnotification.update',$notification->id) }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" value="{{$notification->title}}" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Message <b style="color:red">{{ $errors->first('message') }}</b></label>
                            <input class="form-control" name="message" type="text" value="{{$notification->message}}" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group" id="type_lay">
                            <label for="example-text-input" class="form-control-label">Select Type <b style="color:red">{{ $errors->first('type') }}</b></label>
                                <select class="form-control" id="type" name="type" onchange="onTypeChange()" required>
                                    ...
                                    <option value="category" @if($notification->action == "category") selected @endif>Category</option>
                                    <option value="subscription" @if($notification->action == "subscription") selected @endif>Subscription</option>
                                    <option value="url" @if($notification->action == "url") selected @endif>Url</option>
                                </select>
                          </div>
                        </div>
                          ...
                          <div class="form-group" id="action_lay">
                               @if($notification->action == "category")
                                ...
                                <select class="form-control" id="type" name="category" required>
                                    ...
                                    <option value="{{ $c->id }}" @if($c->id == $notification->action_item) selected @endif>{{ $c->name }}</option>
                                    @endforeach
                                </select>
                                
                                @elseif($notification->action == "subscription")
                                ...
                                @elseif($notification->action == "url")
                                
                                <label for="example-text-input" class="form-control-label">Url <b style="color:red">{{ $errors->first("title") }}</b></label>
                                <input class="form-control" name="url" type="text" value="{{ $notification->action_item }}" required> 
                                @endif
                          </div>
                        </div>
                            ...
                            <div class="row mb" id="previewImages">
                                ...
                                <div class='imageCard col-xl-2 col-sm-3 mb-2'>
                                  <div class='avatar avatar-xxl position-relative'>
                                    <img src='{{ asset($notification->thumbnail) }}' id='imge' class='border-radius-md' alt='team-2'>
                                  </div>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="col-md-12" >
                            <div class="form-check form-switch">
                              <input class="form-check-input" name="send_push" type="checkbox" id="rememberMe">
                              <label class="form-check-label" for="rememberMe">Send Push Notification Again</label>
                            </div>
                        </div>
