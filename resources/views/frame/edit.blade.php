          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Frame</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('frame.update',$frame->id) }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" value="{{ $frame->title }}" required>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Select Category <b style="color:red">{{ $errors->first('type') }}</b></label>
                                ...
                                <option value="{{ $category->id }}" @if($frame->category_id == $category->id) selected @endif>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                          ...
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Select Type <b style="color:red">{{ $errors->first('type') }}</b></label>
                                ...
                                <select class="form-control" id="type" name="type" required>
                                    ...
                                    <option value="political" @if($frame->type == "political") selected @endif>Political</option>
                                    <option value="business" @if($frame->type == "business") selected @endif>Business</option>
                                </select>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="premium" required="required">
                                ...
                                <option value="1" @if($frame->premium == "1") selected @endif>Premium</option>
                            </select>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Frame Size <b style="color:red">{{ $errors->first('type') }}</b></label>
                                ...
                                <select class="form-control" id="ratio" name="ratio" required>
                                    ...
                                    <option value="4:5" @if($frame->ratio == "4:5") selected @endif>4:5 (Portrait)</option>
                                    <option value="16:9" @if($frame->ratio == "16:9") selected @endif>16:9 (Landscap)</option>
                                    <option value="9:16" @if($frame->ratio == "9:16") selected @endif>9:16 (Story)</option>
                                    <option value="3:4" @if($frame->ratio == "3:4") selected @endif>3:4 (Pinterest)</option>
                                </select>
                            ...
                            <div class="row mb" id="previewImages">
                                ...
                                <div class='imageCard col-xl-2 col-sm-3 mb-2'>
                                  <div class='avatar avatar-xxl position-relative'>
                                    <img src='{{ asset($frame->thumbnail) }}' id='imge' class='border-radius-md' alt='team-2'>
                                  </div>
                                </div>
                            </div>
                            </div>
