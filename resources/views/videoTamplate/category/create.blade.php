          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Video Tamplate Category</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('videotamplatecategory.store') }}" id="addform" enctype="multipart/form-data" >
