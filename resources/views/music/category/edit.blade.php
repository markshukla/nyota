          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Music Category</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action=" {{ route('musiccategory.update',$category->id) }} " id="addform" enctype="multipart/form-data" >
                    @csrf
                    @method('PUT')
                    <div class="row">
