          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Music Category</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action=" {{ route('musiccategory.store') }} " id="addform" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" placeholder="Trending" required>
