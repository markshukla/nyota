          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Edit Political Post</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('political.update',$post->id) }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Select Party <b style="color:red">{{ $errors->first('category') }}</b></label>
                            ...
                            <div class="row mb" id="previewImages">
                                <div class="imageCard col-xl-2 col-sm-3 mb-2">
                                  <div class="avatar avatar-xxl position-relative">
                                    <img src="{{ url($post->thumb_url) }}" id="imge" class="border-radius-md" alt="team-2">
