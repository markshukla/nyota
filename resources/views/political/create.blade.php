          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Political Post</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action=" {{ route('political.store') }} " id="addform" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6" id="post_type_lay">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="post_type" id="post_type" onchange="typeChange()">
