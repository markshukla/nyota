          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 font-weight-bolder">Add Custom Tamplate</p>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('invitationcard.store') }}" id="addform" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" placeholder="Card 1" required>
                          </div>
                        </div>
