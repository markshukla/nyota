                    ...
                    @foreach ($categories as $category)
                       <tr>
                            ...
                            <div class="ms-auto text-end align-middle text-center text-sm">
                                ...
                                <a class="btn btn-icon-only btn-rounded btn btn-success" href="{{secure_url('/category/'.$category->id.'/edit')}}"><i class="fas fa-pencil-alt"></i></a>
                            </div>
                            </td>
                       </tr>
                       
                        <form action="{{ url('category/'.$category->id) }}" method="POST" id="form-{{ $category->id }}">
                            @method('DELETE')
                            @csrf
